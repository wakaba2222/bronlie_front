...
//			var_dump($arrResult['arrItem']);
	...
	{
$sitekey = '6LeJJbkqAAAAAKLSD2lobawpudnhfwSSqrjj85xt';        // reCAPTCHA v3 sitekey
$secretkey = '6LeJJbkqAAAAANp_8K_-jnV-sBTm-YxPsm5tvKAg'; // reCAPTCHA v3 secretkey
...
//    return Response::forge($this->action_404(), 404);
