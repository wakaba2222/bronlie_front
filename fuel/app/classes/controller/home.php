...
//		$arrResult['arrEditorsChoice'] = get_editors_choice_list( 12 );		// EDITORS CHOICE 12記事
		...
		$arrTemp = array();
//		if (isset($arrResult_pin['arrBlog']['arrPosts']))
//		{
//			foreach($arrResult_pin['arrBlog']['arrPosts'] as $article)
//			{
...
//			}
//		}
		foreach($arrResult['arrBlog']['arrPosts'] as $article)
		{
			if ($article['pin'] != '')
			{
				$article['pin'] = 'on';
		...
		$arrResult['arrBlog']['arrPosts'] = $arrTemp;//get_blog_article_list( 12, $page, "", "" );	// 1ページ12記事
