...
<!--{%if $smarty.SESSION.authority == 0%}-->
        ...
        <li id="navi-products" class="<!--{%if $tpl_mainno eq "shop"%}-->on<!--{%/if%}-->">
            <a href="<!--{%$smarty.const.ROOT_URLPATH%}--><!--{%$smarty.const.ADMIN_DIR%}-->shop/<!--{%$smarty.const.DIR_INDEX_PATH%}-->"><span>ショップ管理</span></a>
...
<!--{%/if%}-->
        <li id="navi-products" class="<!--{%if $tpl_mainno eq "products"%}-->on<!--{%/if%}-->">
            <a href="<!--{%$smarty.const.ROOT_URLPATH%}--><!--{%$smarty.const.ADMIN_DIR%}-->product/<!--{%$smarty.const.DIR_INDEX_PATH%}-->"><span>商品管理</span></a>
