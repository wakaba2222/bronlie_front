...
*%}-->
<li<!--{%if $tpl_subno == 'delivery'%}--> class="on"<!--{%/if%}--> id="navi-basis-delivery"><a href="/admin/basis/delivery"><span>配送方法設定</span></a></li>
<!--{%*
...
*%}-->
<li<!--{%if $tpl_subno == 'point'%}--> class="on"<!--{%/if%}--> id="navi-basis-point"><a href="/admin/basis/point"><span>ポイント関連設定</span></a></li>
<li<!--{%if $tpl_subno == 'campaign'%}--> class="on"<!--{%/if%}--> id="navi-basis-point"><a href="/admin/basis/campaign"><span>クーポン関連設定</span></a></li>
<li<!--{%if $tpl_subno == 'campaign_none'%}--> class="on"<!--{%/if%}--> id="navi-basis-point"><a href="/admin/basis/campaign_none" target="_blank"><span>クーポン対象外商品一覧</span></a></li>
<li<!--{%if $tpl_subno == 'searchtag'%}--> class="on"<!--{%/if%}--> id="navi-basis-searchtag"><a href="/admin/tag"><span>検索タグ設定</span></a></li>
<li<!--{%if $tpl_subno == 'brand'%}--> class="on"<!--{%/if%}--> id="navi-basis-searchtag"><a href="/admin/brand"><span>ブランド表示設定</span></a></li>
<li<!--{%if $tpl_subno == 'mail'%}--> class="on"<!--{%/if%}--> id="navi-basis-mail"><a href="/admin/mailset"><span>メール設定</span></a></li>
<li<!--{%if $tpl_subno == 'template'%}--> class="on"<!--{%/if%}--> id="navi-basis-mail"><a href="/admin/template"><span>広告設定</span></a></li>
<!--{%*
