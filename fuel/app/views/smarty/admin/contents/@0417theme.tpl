...
*}-->
        ...
        <tr>
            ...
            <td>
                ...
                <textarea name="list_title" cols="80" rows="10"><!--{$arrForm.list_title|h}--></textarea>
...
<!--{*
                ...
                <!--{/if}-->
*}-->
				<a href="<!--{$smarty.const.HTTP_URL}-->theme/<!--{$arrNews[data].news_category}-->/?admin=on" target="_blank"><!--{$arrNews[data].news_title|h|nl2br}--></a>
            </td>
            <td>
