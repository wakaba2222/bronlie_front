...
*}-->
				...
				<a href="<!--{$smarty.const.HTTP_URL}-->mall/<!--{$arrNews[data].creator_id|h}-->/staff_entry/?entry=<!--{$arrNews[data].news_id}-->&admin=on" target="_blank"><!--{$arrNews[data].news_title|h|nl2br}--></a>
				<!--{else}-->
