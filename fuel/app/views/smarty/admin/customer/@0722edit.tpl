...
<form name="form1" id="form1" method="post" action="?" autocomplete="off">
    ...
    <input type="hidden" name="mailmaga" value="<!--{$arrForm.mailmaga|h}-->" />
...
<!--{if $arrForm.status != '0' && $arrForm.status != '4'}-->
            <tr>
...
<!--{else}-->
                <li><a class="btn-action" href="javascript:;" onclick="fnSetFormSubmit('form1', 'mode', 'confirm'); return false;"><span class="btn-next">変更</span></a></li>
<!--{/if}-->
            </ul>
        </div>
        ...
        <!--{include file=$tpl_pager}-->
            ...
            <table class="list">
                ...
                <!--{if $arrPurchaseHistory[cnt].status != 3}-->
                    <tr>
