...
<input type="hidden" id="shop_mode" name="shop_mode" value="" />
            ...
            <td>
                ...
                <!--{if $shop_mode == ''}-->
	                ...
	                *}-->
	                <!--{/if}-->
                <!--{else}-->
                	<!--{foreach key=cc item=os from=$arrORDERSTATUS}-->
                		<!--{if $cc == $arrForm[$key].value}-->
                		<!--{$os}-->
                		<!--{/if}-->
                	<!--{/foreach}-->
                <!--{/if}-->
...
<p>消費税率　
    <!--{assign var=key value="tax_in"}-->
    <span class="attention"><!--{$arrErr[$key]}--></span>
    <input type="text" name="<!--{$key}-->" <!--{if $tpl_mode != 'add'}-->disabled="disabled"<!--{/if}--> value="<!--{if $arrForm[$key].value || $arrForm[$key].value == '0'}--><!--{$arrForm[$key].value}--><!--{else}--><!--{$CONF.tax}--><!--{/if}-->" maxlength="3" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" size="5" class="box6" />
    ％
</p>
    ...
    <table class="list" id="order-edit-products">
        <tr>
            ...
            <th class="name">商品名/柄/カラー/サイズ</th>
...
<!--{if $shop_mode}-->
<!--{if $arrForm.shop_mode.value[$product_index] == $shop_mode}-->
        <tr>
            <td>
            ...
            <td>
                ...
                <input type="hidden" name="shop_name[<!--{$product_index}-->]" value="<!--{$arrForm.shop_name.value[$product_index]|h}-->" id="shop_name<!--{$product_index}-->" />
                ...
                <br />
                <!--{*## 追加規格 ADD BEGIN ##*}-->
                <!--{if $arrExtra[$product_index]|@count > 0}-->
                    <!--{assign var=key value="extra_info"}-->
                    <!--{section name=extra loop=$arrExtra[$product_index]}-->
                        <!--{assign var=exidx value=`$smarty.section.extra.index`}-->
                        <!--{$arrExtra[$product_index][$exidx].extra_class_name}-->：&nbsp;<!--{$arrExtra[$product_index][$exidx].extra_classcategory_name}--><br />
                    <!--{/section}-->
                <!--{/if}-->
                <!--{*## 追加規格 ADD END ##*}-->
...
<!--{/if}-->
            ...
            <!--{if $arrExtra[$product_index]|@count > 0}-->
                ...
                <!--{section name=extra loop=$arrExtra[$product_index]}-->
                    <!--{assign var=exidx value=`$smarty.section.extra.index`}-->
                    <input type="hidden" name="<!--{$key}-->[<!--{$product_index}-->][<!--{$exidx}-->][extra_class_name]" value="<!--{$arrExtra[$product_index][$exidx].extra_class_name}-->" id="extra_info_nm<!--{$product_index}-->_<!--{$exidx}-->" />
                    <input type="hidden" name="<!--{$key}-->[<!--{$product_index}-->][<!--{$exidx}-->][extra_classcategory_name]" value="<!--{$arrExtra[$product_index][$exidx].extra_classcategory_name}-->" id="extra_info_ctg<!--{$product_index}-->_<!--{$exidx}-->" />
                <!--{/section}-->
            <!--{/if}-->
            <!--{*## 追加規格 ADD END ##*}-->
            </td>
            <td align="center">
                ...
                <input type="text" name="<!--{$key}-->[<!--{$product_index}-->]" <!--{if $tpl_mode != 'add'}-->disabled="disabled"<!--{/if}--> value="<!--{$arrForm[$key].value[$product_index]|h}-->" size="6" class="box6" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key][$product_index]|sfGetErrorColor}-->" id="<!--{$key}-->_<!--{$product_index}-->" /> 円
            </td>
            <td align="center">
                <!--{assign var=key value="quantity"}-->
                <span class="attention"><!--{$arrErr[$key][$product_index]}--></span>
                <input type="text" name="<!--{$key}-->[<!--{$product_index}-->]" <!--{if $tpl_mode != 'add'}-->disabled="disabled"<!--{/if}--> value="<!--{$arrForm[$key].value[$product_index]|h}-->" size="3" class="box3" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key][$product_index]|sfGetErrorColor}-->" id="<!--{$key}-->_<!--{$product_index}-->" />
            </td>
            <!--{assign var=price value=`$arrForm.price.value[$product_index]`}-->
            <!--{assign var=quantity value=`$arrForm.quantity.value[$product_index]`}-->
		    <!--{assign var=key_tax value="tax_in"}-->

            <!--{if $arrForm[$key_tax].value}-->
            <td class="right"><!--{$price|sfCalcIncTax:$arrForm[$key_tax].value:$arrInfo.tax_rule|number_format}--> 円</td>
            <td class="right"><!--{$price|sfCalcIncTax:$arrForm[$key_tax].value:$arrInfo.tax_rule|sfMultiply:$quantity|number_format}-->円</td>
            <!--{elseif $arrForm[$key_tax].value == '0'}-->
            <td class="right"><!--{$price|number_format}--> 円</td>
            <td class="right"><!--{$price|sfMultiply:$quantity|number_format}-->円</td>
            <!--{else}-->
...
<!--{else}-->
        <tr>
            ...
            <td>
                <!--{$arrForm.product_name.value[$product_index]|h}-->/<!--{$arrForm.classcategory_name1.value[$product_index]|default:"(なし)"|h}-->/<!--{$arrForm.classcategory_name2.value[$product_index]|default:"(なし)"|h}-->
                <input type="hidden" name="shop_name[<!--{$product_index}-->]" value="<!--{if $arrForm.shop_name.value[$product_index]|h}--><!--{$arrForm.shop_name.value[$product_index]|h}--><!--{elseif $arrForm.shop_mode.value[$product_index]|h}--><!--{$arrForm.shop_mode.value[$product_index]|h}--><!--{/if}-->" id="shop_name<!--{$product_index}-->" />
                <input type="hidden" name="product_name[<!--{$product_index}-->]" value="<!--{$arrForm.product_name.value[$product_index]|h}-->" id="product_name_<!--{$product_index}-->" />
                <input type="hidden" name="classcategory_name1[<!--{$product_index}-->]" value="<!--{$arrForm.classcategory_name1.value[$product_index]|h}-->" id="classcategory_name1_<!--{$product_index}-->" />
                <input type="hidden" name="classcategory_name2[<!--{$product_index}-->]" value="<!--{$arrForm.classcategory_name2.value[$product_index]|h}-->" id="classcategory_name2_<!--{$product_index}-->" />
                <br />
...
<!--{if !$shop_mode}-->
        ...
        <tr>
            ...
            <td class="right">
                ...
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <input type="text" <!--{if $tpl_mode != 'add'}-->disabled="disabled"<!--{/if}--> name="<!--{$key}-->" value="<!--{$arrForm[$key].value|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" size="5" class="box6" />
                円
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4" class="right">
                <!--{assign var=key value="recepit_tadashi"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <!--{$arrForm[$key].value|h}-->
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4" class="right">
                ...
                <!--{assign var=msg value=`$arrForm[$key].value`}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
				<!--{$arrMsgCard[$msg]|h}-->
            </td>
        </tr>
        <tr>
            ...
            <td colspan="4" class="right">
                <!--{assign var=key value="msg_card_msg"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <!--{$arrForm[$key].value|h}-->
            </td>
        </tr>
<!--{*
        <tr>
            <th colspan="2" class="column right">備考</th>
            <td colspan="3" class="right">
                <!--{assign var=key value="message"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <input type="text" disabled="disabled" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|nl2br|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" size="5" class="box60" />
            </td>
        </tr>
*}-->
