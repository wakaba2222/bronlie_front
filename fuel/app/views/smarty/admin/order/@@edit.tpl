    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                ...
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <input type="text" name="<!--{%$key%}-->" value="<!--{%$arrForm[$key]|h%}-->" size="60" class="box60 top"  /><br />
                <!--{%assign var=key value="addr02"%}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <input type="text" name="<!--{%$key%}-->" value="<!--{%$arrForm[$key]|h%}-->" size="60" class="box60" />
            </td>
        </tr>
        <tr>
            <th>備考</th>
...
<!--{%/foreach%}-->
        ...
        <tr>
            ...
            <td class="right">
                ...
                <!--{%$arrForm.payment_total|number_format%}-->
                円
            </td>
        </tr>
        <tr>
    ...
    <h2>お届け先情報<h2>
        ...
        <tr>
            ...
            <td>
                ...
                <!--{%assign var=key2 value="name02"%}-->
                <span class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></span>
                <input type="text" name="<!--{%$key1%}-->" value="<!--{%$arrDeliv[$key1]%}-->" size="15" class="box15" />
                <input type="text" name="<!--{%$key2%}-->" value="<!--{%$arrDeliv[$key2]%}-->" size="15" class="box15" />
            </td>
        </tr>
        <tr>
            <th>お名前(フリガナ)</th>
            <td>
                ...
                <!--{%assign var=key2 value="kana02"%}-->
                <span class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></span>
                <input type="text" name="<!--{%$key1%}-->" value="<!--{%$arrDeliv[$key1]|h%}-->" size="15" class="box15" />
                <input type="text" name="<!--{%$key2%}-->" value="<!--{%$arrDeliv[$key2]|h%}-->" size="15" class="box15" />
            </td>
        </tr>
        <tr>
            <th>TEL</th>
            <td>
                <!--{%assign var=key1 value="tel01"%}-->
                <span class="attention"><!--{$arrErr[$key1]}--></span>
                <input type="text" name="<!--{%$key1%}-->" value="<!--{%$arrDeliv[$key1]|h%}-->" size="20" class="box20" />
            </td>
        </tr>
        <tr>
            <th>住所</th>
            <td>
                ...
                <span class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></span>
                〒
                <input type="text" name="<!--{%$key1%}-->" value="<!--{%$arrDeliv[$key1]|h%}-->" size="6" class="box6" />
                -
                <input type="text" name="<!--{%$key2%}-->" value="<!--{%$arrDeliv[$key2]|h%}-->" size="6" class="box6" />
                <!--{%assign var=key value="pref"%}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <select class="top" name="<!--{%$key%}-->">
                    <option value="" selected="">都道府県を選択</option>
                ...
                <!--{%assign var=key value="addr01"%}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <input type="text" name="<!--{%$key%}-->" value="<!--{%$arrDeliv[$key]|h%}-->" size="60" class="box60 top"  /><br />
                <!--{%assign var=key value="addr02"%}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <input type="text" name="<!--{%$key%}-->" value="<!--{%$arrDeliv[$key]|h%}-->" size="60" class="box60" />
            </td>
        </tr>
            <tr>
                <th>お届け時間</th>
