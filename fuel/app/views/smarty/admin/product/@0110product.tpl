...
function sendFile(file, el) {
	var url = "https://origin.bronline.jp/api/addpimg";
...
-->
        ...
        <tr>
            ...
            <td>
                ...
                <select name="arrProduct[brand_id]" id="brand_id">
        ...
        <tr>
            ...
            <td>
                ...
                カラー名：<input type="text" name="arrProductCode[color_name][]" value="<!--{%$sku.color_name%}-->" maxlength="30" size="30" class="box60" /><br>
                サイズコード：<input type="text" name="arrProductCode[size_code][]" value="<!--{%$sku.size_code%}-->" maxlength="10" size="30" class="box60" />
                サイズ名：<input type="text" name="arrProductCode[size_name][]" value="<!--{%$sku.size_name%}-->" maxlength="30" size="30" class="box60" /><br>
                ...
                カラー名：<input type="text" name="arrProductCode[color_name][]" value="" maxlength="30" size="30" class="box60" /><br>
                サイズコード：<input type="text" name="arrProductCode[size_code][]" value="" maxlength="10" size="30" class="box60" />
                サイズ名：<input type="text" name="arrProductCode[size_name][]" value="" maxlength="30" size="30" class="box60" /><br>
        ...
        <tr>
            ...
            <td>
                ...
                <option value="<!--{%$key%}-->" <!--{%if $key == $category_id%}-->selected<!--{%/if%}-->><!--{%$category%}--><!--{%if $key >= 600%}-->(レディース)<!--{%/if%}--></option>
                <!--{%/foreach%}-->
                </select>
            </td>
        </tr>
