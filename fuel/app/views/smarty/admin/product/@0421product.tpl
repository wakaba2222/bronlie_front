...
<!--{%/if%}-->
        <tr>
            ...
            <label><input class="reservation_check" type="radio" value="1" name="arrProduct[reservation_flg]" <!--{%if $arrProduct.reservation_flg == 1%}-->checked<!--{%/if%}--> />予約商品</label>
            </td>
        </tr>
        <tr>
