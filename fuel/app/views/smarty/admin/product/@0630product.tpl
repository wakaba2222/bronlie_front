...
function imageFileUpload(f) {
    ...
    .done(function(data){
        ...
        img.width = 200;
        img.class = 'img_name';
        var str = '<li class="img_li"><img src="'+ data.img +'" width="200"><input type="hidden" name="arrImages[images][]" value="'+data.img+'" /><br>タグ：<input type="text" name="arrImages[tags][]" /><button class="del">削除</button>';
...
*%}-->
        ...
        <tr>
            ...
            <div id="images_area">
                ...
                <li class="img_li"><img src="<!--{%$smarty.const.UPLOAD_IMAGE_PATH%}--><!--{%$shop%}-->/<!--{%$image.path%}-->" width="200"><input type="hidden" name="arrImages[images][]" value="<!--{%$smarty.const.UPLOAD_IMAGE_PATH%}--><!--{%$shop%}-->/<!--{%$image.path%}-->" /><br>タグ：<input type="text" name="arrImages[tags][]" value="<!--{%$image.tag%}-->" /><button class="del">削除</button>
