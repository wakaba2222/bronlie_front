...
<input type="hidden" name="sql_id" value="1">
...
<!--{*                <th nowrap><a href="#" onClick="lfnDispChange(); return false;">カテゴリ ⇔ URL</a></th> *}-->
            ...
            <!--{section name=cnt loop=$arrProducts}-->
                ...
                <tr style="background:<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->;">
                    ...
                    <td rowspan="1"><!--{$arrProducts[cnt].product_code_min|h}-->
                    ...
                    <td><!--{$arrProducts[cnt].name|h}--><!--{if $arrProducts[cnt].name2}--> / <!--{$arrProducts[cnt].name2|h}--><!--{/if}--></td>
                    <!--{* 在庫 *}-->
