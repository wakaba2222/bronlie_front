...
<input type="hidden" name="smaregi_product_id" value="<!--{$arrForm.smaregi_product_id|h}-->" />
<input type="hidden" name="select_recommend_no" value="" />
<input type="hidden" name="shop_mode" value="<!--{$shop_mode}-->" />
<input type="hidden" name="wear_shop_id" value="" />
<input type="hidden" name="recomment_shop_id" value="" />
<input type="hidden" name="select_wear_no" value="" />
...
<!--{if $arrForm.smaregi_product_id}-->
        <tr>
            <th>スマレジ商品ID</th>
            <td><!--{$arrForm.smaregi_product_id|h}--></td>
        </tr>
<!--{/if}-->
        <tr>
            <th>グランドコンテンツに記載する</th>
            <td>
            <label><input type="checkbox" name="v_mall" value="1" <!--{if $arrForm.v_mall == 1}-->checked<!--{/if}--> />グランドコンテンツに記載する</label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="name" value="<!--{$arrForm.name|h}-->" maxlength="85" style="<!--{if $arrErr.name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="name2" value="<!--{$arrForm.name2|h}-->" maxlength="85" style="<!--{if $arrErr.name2 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限85文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="name_kana" value="<!--{$arrForm.name_kana|h}-->" maxlength="85" style="<!--{if $arrErr.name_kana != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限85文字)</span>
            </td>
        </tr>
        <tr>
            <th>作成日時<br><span class="attention">入力無し時は時刻が自動で反映されます。</span></th>
            <td>
                <span class="attention"><!--{$arrErr.create_date}--></span>
                <input type="text" name="create_date" value="<!--{$arrForm.create_date|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.create_date != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            <th>更新日時<br><span class="attention">入力無し時は時刻が自動で反映されます。</span></th>
            <td>
                <span class="attention"><!--{$arrErr.update_date}--></span>
                <input type="text" name="update_date" value="<!--{$arrForm.update_date|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.update_date != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
            </td>
        </tr>
<!--{if $arrBrand}-->
        <tr>
            ...
            <td>
                ...
                <option value="<!--{$arrBrand[bc].extra_classcategory_id}-->" <!--{if $arrForm.brand_id == $arrBrand[bc].extra_classcategory_id}-->selected<!--{/if}-->><!--{$arrBrand[bc].name}--></option>
                <!--{/section}-->
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <!--{section name=bc loop=$arrColor}-->
                <option value="<!--{$arrColor[bc].extra_classcategory_id}-->" <!--{if $arrForm.color_id == $arrColor[bc].extra_classcategory_id}-->selected<!--{/if}-->><!--{$arrColor[bc].name}-->(<!--{$arrColor[bc].p_code}-->)</option>
                <!--{/section}-->
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select name="size_id">
                <!--{section name=bc loop=$arrSize}-->
                <option value="<!--{$arrSize[bc].extra_classcategory_id}-->" <!--{if $arrForm.size_id == $arrSize[bc].extra_classcategory_id}-->selected<!--{/if}-->><!--{$arrSize[bc].name}-->(<!--{$arrSize[bc].p_code}-->)</option>
                <!--{/section}-->
                </select>
            </td>
        </tr>
...
<!--{if $shop_mode}-->
        <tr>
            ...
            <td>
                ...
                <span class="attention"> (<!--{$smarty.const.STEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            <th>グループコード</th>
            <td>
                <span class="attention"><!--{$arrErr.group_code}--></span>
                <input type="text" name="group_code" value="<!--{$arrForm.group_code|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.group_code != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (<!--{$smarty.const.STEXT_LEN}-->文字)</span><br/>
                <label><input type="checkbox" name="group_view" value="1" <!--{if $arrForm.group_view == '1'}-->checked<!--{/if}--> />主商品とする</label><span class="attention"> (グループ化する場合、主商品以外はチェックを外してください)</span>
            </td>
        </tr>
<!--{else}-->
        <tr>
            ...
            <td>
                <span class="attention"><!--{$arrErr.product_code}--></span>
                <input type="text" name="product_code" value="<!--{$arrForm.product_code|h}-->" maxlength="<!--{$smarty.const.P_CODE_LEN}-->" style="<!--{if $arrErr.product_code != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (<!--{$smarty.const.P_CODE_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            <th>グループコード</th>
            <td>
                <span class="attention"><!--{$arrErr.group_code}--></span>
                <input type="text" name="group_code" value="<!--{$arrForm.group_code|h}-->" maxlength="14" style="<!--{if $arrErr.group_code != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (14文字)</span><br/>
                <label><input type="checkbox" name="group_view" value="1" <!--{if $arrForm.group_view == '1'}-->checked<!--{/if}--> />主商品とする</label><span class="attention"> (グループ化する場合、主商品以外はチェックを外してください)</span>
            </td>
        </tr>
<!--{/if}-->
        <tr>
            <th>商品URL</th>
            <td>
                <span class="attention"><!--{$arrErr.product_url}--></span>
                <input type="text" name="product_url" value="<!--{$arrForm.product_url|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.product_url != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th>原価</th>
            <td>
                <span class="attention"><!--{$arrErr.cost_price}--></span>
                <input type="text" name="cost_price" value="<!--{$arrForm.cost_price|h}-->" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.cost_price != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
            </td>
        </tr>
        <tr>
            <th>在庫数<span class="attention"> *</span></th>
            <td>
            <input type="hidden" name="sub_shop" value="<!--{$arrForm.sub_shop}-->" />
            <!--{if $arrForm.sub_shop != 0}-->
            	<input type="hidden" name="stock_type" value="1" />
                <input readonly="true" type="text" name="stock" value="<!--{$arrForm.stock|h}-->" size="6" class="box6" maxlength="<!--{$smarty.const.AMOUNT_LEN}-->" style="<!--{if $arrErr.stock != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/>
            <!--{else}-->
            	<label><input type="radio" name="stock_type" value="1" checked />WebAPI(分子)</label>
            	<label><input type="radio" name="stock_type" value="2" />仕入れ(分母)</label><br/>
...
*}-->
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="size" value="<!--{$arrForm.size|h}-->" maxlength="85" style="<!--{if $arrErr.size != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限85文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="color" value="<!--{$arrForm.color|h}-->" maxlength="85" style="<!--{if $arrErr.color != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限85文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="tag" value="<!--{$arrForm.tag|h}-->" maxlength="85" style="<!--{if $arrErr.tag != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限85文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="season" value="<!--{$arrForm.season|h}-->" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.season != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="material" value="<!--{$arrForm.material|h}-->" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.material != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <textarea name="size_text" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.size_text != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" cols="60" rows="8" class="area60"><!--{"\n"}--><!--{$arrForm.size_text|h}--></textarea><br />
                <span class="attention"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <textarea name="remarks" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.remarks != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" cols="60" rows="8" class="area60"><!--{"\n"}--><!--{$arrForm.remarks|h}--></textarea><br />
                <span class="attention"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            <th style="background-image:none;background-color:#FFAE00;">原産国</th>
            <td>
                <span class="attention"><!--{$arrErr.country}--></span>
                <input type="text" name="country" value="<!--{$arrForm.country|h}-->" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.country != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
                <span class="attention"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th>詳細-メインコメント(説明)<span class="attention">(タグ許可)</span></th>
            <td>
        ...
        <tr>
            ...
            <th>一覧-メイン画像(マウスオーバー)<br />[<!--{$smarty.const.SMALL_IMAGE_WIDTH}-->×<!--{$smarty.const.SMALL_IMAGE_HEIGHT}-->]</th>
            <td>
                <a name="<!--{$key}-->"></a>
                <a name="main_image"></a>
                <a name="main_large_image"></a>
                ...
                <img src="<!--{$arrForm.arrFile[$key].filepath}-->" alt="<!--{$arrForm.name|h}-->" />　<a href="" onclick="selectAll('category_id'); fnModeSubmit('delete_image', 'image_key', '<!--{$key}-->'); return false;">[画像の取り消し]</a><br />
                <!--{/if}-->
                <input type="file" name="main_list_image2" size="40" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" />
                <a class="btn-normal" href="javascript:;" name="btn" onclick="selectAll('category_id'); fnModeSubmit('upload_image', 'image_key', '<!--{$key}-->'); return false;">アップロード</a>
            </td>
        </tr>
<!--{*
...
*}-->
<!--{if $shop_mode != '' && $arrForm.group_view == '1'}-->
	<tr>
		<th>カラー</th>
		<td>
        <!--{if !$arrForm.sub_shop}-->
		<!--{section name=cc loop=$arrColorList}-->
		<!--{$arrColorList[cc].p_code}-->:<input type="text" name="color_name[<!--{$arrColorList[cc].p_code}-->]" value="<!--{$arrColorList[cc].name}-->" size="20" /><br>
		<!--{/section}-->
		<!--{else}-->
		<!--{section name=cc loop=$arrColorList}-->
		<!--{$arrColorList[cc].p_code}-->:<input type="text" readonly="true" name="color_name[<!--{$arrColorList[cc].p_code}-->]" value="<!--{$arrColorList[cc].name}-->" size="20" /><br>
		<!--{/section}-->
		<!--{/if}-->
		</td>
	</tr>
	<tr>
		...
		<td>
        <!--{if !$arrForm.sub_shop}-->
		<!--{section name=cc loop=$arrSizeList}-->
		<!--{$arrSizeList[cc].p_code}-->:<input type="text" name="size_name[<!--{$arrSizeList[cc].p_code}-->]" value="<!--{$arrSizeList[cc].name}-->" size="20" /><br>
		<!--{/section}-->
		<!--{else}-->
		<!--{section name=cc loop=$arrSizeList}-->
		<!--{$arrSizeList[cc].p_code}-->:<input type="text" readonly="true" name="size_name[<!--{$arrSizeList[cc].p_code}-->]" value="<!--{$arrSizeList[cc].name}-->" size="20" /><br>
		<!--{/section}-->
		<!--{/if}-->
		</td>
	</tr>
...
*}-->
    ...
    <div class="btn">
        <a class="btn-normal" href="javascript:;" onclick="selectAll('category_id'); lfDispSwitch('recommend_select'); return false;"><span>WEAR WITH IT／RELATED ITEMS　表示/非表示</span></a>
    </div>
    ...
    <table class="form">
        ...
        <!--{assign var=wear_no value="`$smarty.section.cnt.iteration`"}-->
        <tr>
            <!--{assign var=key value="wear_id`$smarty.section.cnt.iteration`"}-->
            <!--{assign var=shopkey value="wear_shop_id`$smarty.section.cnt.iteration`"}-->
            <!--{assign var=anckey value="wear_no`$smarty.section.cnt.iteration`"}-->
            <th>WEAR WITH IT(<!--{$smarty.section.cnt.iteration}-->)<br />
                <!--{if $arrWearit[$wear_no].product_id}-->
                    <img src="<!--{$smarty.const.ROOT_URLPATH}-->resize_image.php?image=<!--{$arrWearit[$wear_no].main_list_image|sfNoImageMainList|h}-->&width=65&height=65" alt="<!--{$arrWearit[$wear_no].name|h}-->" />
                <!--{/if}-->
            </th>
            <td>
                <a name="<!--{$anckey}-->"></a>
                <input type="hidden" name="<!--{$key}-->" value="<!--{$arrWearit[$wear_no].product_id|h}-->" />
                <input type="hidden" name="<!--{$shopkey}-->" value="<!--{$arrWearit[$wear_no].shop_mode|h}-->" />
                <a class="btn-normal" href="javascript:;" name="change" onclick="selectAll('category_id'); win03('./product_select.php?m=wear&no=<!--{$smarty.section.cnt.iteration}-->', 'search', '615', '500'); return false;">変更</a>
                <!--{assign var=key value="wear_delete`$smarty.section.cnt.iteration`"}-->
                <input type="checkbox" name="<!--{$key}-->" value="1" />削除<br />
                <!--{assign var=key value="wear_comment`$smarty.section.cnt.iteration`"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                商品コード:<!--{$arrWearit[$wear_no].product_code_min}--><br />
                商品名:<!--{$arrWearit[$wear_no].name|h}--><br />
                <textarea name="<!--{$key}-->" cols="60" rows="8" class="area60" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" ><!--{"\n"}--><!--{$arrWearit[$wear_no].comment|h}--></textarea><br />
    ...
    <table class="form">
        ...
        <!--{assign var=recomment_shopkey value="recommend_shop_id`$smarty.section.cnt.iteration`"}-->
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="<!--{$recomment_shopkey}-->" value="<!--{$arrRecommend[$recommend_no].shop_mode|h}-->" />
