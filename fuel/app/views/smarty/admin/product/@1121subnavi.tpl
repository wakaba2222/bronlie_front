...
<li<!--{if $tpl_subno == 'extracheck'}--> class="on"<!--{/if}--> id="navi-products-extracheck"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/extra_class_check.php"><span>規格情報参照</span></a></li>
<!--{/if}-->
</ul>
