...
<div id="basis" class="contents-main">
    ...
    <table>
    	...
    	<tr class="parent">
	   		...
	   		<td>
				<input type="text" name="parent_category[parent_category_id][]" id="xx" value="<!--{%$item.parent_category_id%}-->">
	   		</td>
	   		<td>
    	...
    	<!--{%/if%}-->
	   		...
	   		<td>
				<input type="text" name="category[parent_category_id][]" id="xx" value="<!--{%$item2.parent_category_id%}-->">
	   		</td>
	   		<td>
