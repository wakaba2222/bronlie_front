...
-->
  ...
  <p class="repletion">代金引換の場合、弊社の領収書は発行できません。<br>詳細は<a href="/guide/payment/#receipt" target="_blank" style="text-decoration: underline;font-weight: bold">こちら</a>をご確認ください。</p>
