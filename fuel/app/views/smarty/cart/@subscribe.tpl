  ...
  <div class="intro">
    ...
    <div class="send-option">
		  <table class="form">
			...
			<!--{%/if%}-->
			<tr><th>会社名</th><td><input type="text" class="col1" name="other_company" value="<!--{%if array_key_exists('other_company', $arrForm) %}--><!--{%$arrForm['other_company']%}--><!--{%/if%}-->"></td></tr>
			<tr><th>部署名</th><td><input type="text" class="col1" name="other_department" value="<!--{%if array_key_exists('other_department', $arrForm) %}--><!--{%$arrForm['other_department']%}--><!--{%/if%}-->"></td></tr>
			<tr>
				<th>郵便番号 <span class="red">※</span></th>
				<td>
