...
<div class="wrap_contents sub">
	<div class="intro">
  	<div class="msg-bloc">
		<!-- suzuki mod start -->
    	<h4>カートシステムのエラーにより<br>ご注文手続きがすべて取り消しされました。</h4>
		<!-- suzuki mod end -->
		</div>
	<!-- suzuki mod start -->
	<p>カートシステムのエラーによりご注文手続きがすべて取り消しされました。<br>
お手数をおかけしますが、再度商品ページより商品をカートに入れて、ご注文のお手続きをお願いいたします。<br>
<br>
エラーの詳細についてのご確認はお問い合わせフォームよりお問い合わせください。その際、ご注文手続きをされた日時をお知らせください。<br>
<br>
