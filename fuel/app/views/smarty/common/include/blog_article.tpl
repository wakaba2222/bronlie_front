	...
	<div class="wrap_contents clearfix">
		<div class="col_left clearfix">
			<div class="head_01 clearfix">
				<h2 class="times">LATEST</h2>
				<ul class="times fr block">
					<li><a href="/blog" class="active" style="pointer-events:auto;">LATEST</a></li>
					<li><a href="/blog/list">MEMBER</a></li>
				</ul>
			</div>
			<div class="load_list">
				...
				<!--{%/if%}-->
					<!--{%if $post['flg_shop']%}-->
					<a class="cel_bloglist block" href="/mall/<!--{%$post['shop_url']%}-->/blog/?entry=<!--{%$post['ID']%}-->">
					<!--{%else%}-->
					<a class="cel_bloglist block" href="/blog/?entry=<!--{%$post['ID']%}-->">
					<!--{%/if%}-->
