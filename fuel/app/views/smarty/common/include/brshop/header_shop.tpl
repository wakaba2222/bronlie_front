...
<!--{%*
		...
		<div class="shop_menu">
			<ul>
				<li>
					<div class="toggle">
						<a href="/mall/<!--{%$shop_url%}-->/justin/?m=1" class="tit_menu block"><span class="bold">JUST IN</span> / 新着アイテム一覧</a>
					</div>
				</li>
				<li>
					<div class="toggle">
					...
					<ul class="menulist_shop">
						<li class="all"><a href="/mall/<!--{%$shop_url%}-->/item/?m=1">ALL ITEMS</a></li>
						<!--{%foreach from=$arrCategory item=cate%}-->
						<li><a href="/mall/<!--{%$shop_url%}-->/item?category=<!--{%$cate.name%}-->&filter=on&m=1"><!--{%$cate.name%}--></a></li>
						<!--{%/foreach%}-->
					</ul>
				</li>
				<li>
					...
					<ul class="menulist_shop">
						...
						<li><a href="/mall/<!--{%$shop_url%}-->/brand/?m=1&filters=<!--{%$brand.code%}-->:::<!--{%$brand.name|urldecode|replace:'&':'-and-'%}-->"><!--{%$brand.name|urldecode%}--></a></li>
						<!--{%/foreach%}-->
						<li><a href="/mall/<!--{%$shop_url%}-->/brand/?m=1">その他ブランド</a></li>
					</ul>
				</li>
				<!--{%if isset($article_num['feature']) && 0 < $article_num['feature']%}-->
				<li>
					<div class="toggle">
						<a href="/mall/<!--{%$shop_url%}-->/feature/?m=1" class="tit_menu block"><span class="bold">FEATURE</span> / 特集</a>
					</div>
				</li>
				<!--{%/if%}-->
				...
				<li>
					<div class="toggle">
						<a href="/mall/<!--{%$shop_url%}-->/stylesnap/?m=1" class="tit_menu block"><span class="bold">STYLE SNAP</span> / スタイリング</a>
					</div>
				</li>
				<!--{%/if%}-->
				...
				<li>
					<div class="toggle">
						<a href="/mall/<!--{%$shop_url%}-->/editorschoice/?m=1" class="tit_menu block"><span class="bold">EDITORS' CHOICE</span> / エディターオススメ</a>
					</div>
				</li>
				<!--{%/if%}-->
				...
				<li>
					<div class="toggle">
						<a href="/mall/<!--{%$shop_url%}-->/blog/?m=1" class="tit_menu block"><span class="bold">BLOG</span> / ブログ</a>
					</div>
				</li>
				<!--{%/if%}-->
			</ul>
