<section class="sec_slide justin">
	<div class="wrap_contents">
		...
		*/</script>
		...
		<!--{%foreach from=$justin item=arrProduct%}-->
			<div>
				...
				<div class="wrap_thum_outer">
					...
					<img loading="lazy" src="/upload/images/<!--{%if $arrProduct.org_shop%}--><!--{%$arrProduct.org_shop%}--><!--{%else%}--><!--{%$arrProduct.login_id%}--><!--{%/if%}-->/<!--{%$arrProduct.path%}-->" alt="<!--{%$arrProduct.title%}-->"/>
					</div>
				</div>
		...
		<a href="<!--{%$mallurl%}-->/justin/" class="times btn_viewmore_sp sp_portrait_only" style="margin-top: 10px;">VIEW ALL</a>
