<section class="sec_slide justin">
	<div class="wrap_contents">
		<div class="head_01 clearfix sp_portrait_none">
			...
			<!--{%if $shop_url|default:"" == 'eskape'%}-->
			<a href="/mall/<!--{%$shop_url%}-->/item" class="times fr btn_viewall"><i class="icon-list"></i> VIEW ALL</a>
			<!--{%elseif $shop_url|default:""%}-->
		...
		<div class="item_menu sp_portrait_only">
			<div>
				<div class="tit_item_menu">
					<a href="/mall/<!--{%$shop_url%}-->/justin"><span class="bold">JUST IN</span>　/　新着アイテム一覧</a>
				</div>
			</div>
			<div>
				<div class="tit_item_menu">
			...
			<div>
				...
				<ul>
					<!--{%if $shop_url%}-->
					<li class="all"><a href="/mall/<!--{%$shop_url%}-->/brand/">ALL BLAND LIST</a></li>
					<!--{%else%}-->
					<li class="all"><a href="/brand/">ALL BLAND LIST</a></li>
					<!--{%/if%}-->
					<!--{%foreach from=$arrBrand item=brand%}-->
					<!--{%if $shop_url%}-->
					<li><a href="/mall/<!--{%$shop_url%}-->/brand/?filters=<!--{%$brand.code%}-->:::<!--{%$brand.name|replace:'&amp;':'-and-'%}-->"><!--{%$brand.name|urldecode%}--></a></li>
					<!--{%else%}-->
		...
		*/</script>
		...
		<!--{%/if%}-->
		<a href="/mall/<!--{%$shop_url%}-->/justin" class="times btn_viewmore_sp sp_portrait_only" style="margin-top: 10px;">VIEW ALL</a>
	</div>
</section>
