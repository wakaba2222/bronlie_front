<section class="sec_slide l_purple">
	<div class="wrap_contents">
		<div class="head_01 t-center mall_logo">
			<h2><img loading="lazy" src="/common/images/logo/brmall_logo.svg" alt="B.R.MALL"><span class="times">SHOP LIST</span></h2>
		...
		<div class="slide_mall owl-carousel">
			...
			<div class="wrap_shop">
			<!--{%/if%}-->
				<a class="shop_logo hovernone" <!--{%if $shop.popup_flg == 1%}-->style="display:none;"<!--{%/if%}--> href="/mall/<!--{%$shop.login_id%}-->/"><img loading="lazy" src="/common/images/mall/<!--{%$shop.login_id%}-->/<!--{%$shop.logo_img%}-->"/></a>
...
<!--{%*
			...
			<!--{%if $key >= 12%}-->
				<a class="shop_logo hovernone" href="/mall/<!--{%$shop.login_id%}-->/"><img loading="lazy" src="/common/images/mall/<!--{%$shop.login_id%}-->/<!--{%$shop.logo_img%}-->"/></a>
			<!--{%/if%}-->
			<!--{%/foreach%}-->
			</div>
*%}-->
