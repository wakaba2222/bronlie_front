...
<!--サイズガイド（guji/ring以外）-->
<!--{%if $shop_url == 'guji' || $shop_url == 'ring'%}-->
<!--サイズガイド（guji/ring専用）-->
...
<!--{%if $shop_url == 'biglietta'%}-->
<div id="chart" class="wrap_size">
	<div class="close"><span></span></div>
	<div class="hidden">
		<div>
			<section class="tit_page"><h2 class="times">SIZE CHART<span>LADIES</span></h2></section>
			<div class="size_detail">
				<p><img src="/common/images/sizeguide/ladies_size.jpg"></p>
			</div>
			<div class="size_detail">
				<h3 class="times">ITALY</h3>
				<p><img src="/common/images/sizeguide/ladies_italy.jpg"></p>
			</div>
			<div class="size_detail">
				<h3 class="times">EU/FRANCE</h3>
				<p><img src="/common/images/sizeguide/ladies_eu_france.jpg"></p>
			</div>
			<div class="size_detail">
				<h3 class="times">US</h3>
				<p><img src="/common/images/sizeguide/ladies_us.jpg"></p>
			</div>
			<div class="size_detail">
				<h3 class="times">DENIM</h3>
				<p><img src="/common/images/sizeguide/ladies_denim.jpg"></p>
			</div>
			<p class="copyright">2018 © B.R.ONLINE All rights reserved.</p>
		</div>
	</div>
