<!--{%assign var="sitekey" value="6LeJJbkqAAAAAKLSD2lobawpudnhfwSSqrjj85xt"%}-->
<!--{%assign var="secretkey" value="6LeJJbkqAAAAANp_8K_-jnV-sBTm-YxPsm5tvKAg"%}-->
...
<!--	<form name="form1" method="post" action="confirm" > -->
	...
	<form name="form1" method="post" action="/contact/confirm" >
