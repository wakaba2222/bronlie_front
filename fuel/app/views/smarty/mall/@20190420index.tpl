...
<!--{%include file='smarty/common/include/showcase_mall.tpl'%}-->
<!--{%include file='smarty/common/include/mall.tpl'%}-->
<!--{%include file='smarty/common/include/justin.tpl'%}-->
<!--{%include file='smarty/common/include/adbnr_middle.tpl'%}-->
