      ...
      <tbody>
		...
		<table class="cart confirm">
			...
			<tr>
				<td>
					<div class="box_item">
					<!--{%if $detail.image|default:""%}-->
						<img class="block fl" src="/upload/images/<!--{%$detail.shop_mode|default:"brshop"%}-->/<!--{%$detail.image%}-->">
					<!--{%else%}-->
						<img class="block fl" src="/upload/images/noimage.png">
					<!--{%/if%}-->
				...
				<td class="border_none">
					<p class="price bold">¥<!--{%($detail.price*1.08)|floor|number_format%}--></p>
				</td>
			</tr>
      ...
      <tr>
        ...
        <table class="cart child" style="border-spacing: 0 15px;">
          ...
          <tr>
            ...
            <td class="price"><span> ¥<!--{%$arrHistory.deliv_fee|number_format%}--></span></td>
          </tr>
          <tr><td colspan="2" class="border_none"><hr></td></tr>
          <tr>
    				<td class="price_info">
            ...
            <td class="price"><span> ¥<!--{%$arrHistory.fee|number_format%}--></span></td>
          </tr>
          <tr><td colspan="2" class="border_none"><hr></td></tr>
          <tr>
    				<td class="price_info">
          ...
          <tr class="total">
            ...
            <td class="price"><span>¥<!--{%($arrHistory.total+$arrHistory.tax)|number_format%}--></span></td>
          </tr>
          <tr>
    				<td class="price_info">
      				<p class="fl">加算ポイント</p>
...
-->
    ...
    <div class="btn_area">
			<a href="/mypage/historylist2" class="back_sys block">戻る</a>
		</div>	
<!--
