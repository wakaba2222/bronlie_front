...
<div class="wrap_contents sub">
	...
	<div class="wrap_benefits">
		...
		<div class="benefits">
			...
			<a href="/guide/point.php" target="_blank" class="block">ポイント＆会員ステージについて</a>
		</div>
		<div class="benefits">
			<h4>3. メールマガジンのお届け</h4>
	...
	<div class="intro">
		...
		<div class="terms">
			<p>
				...
				3. 当社は、会員に対して、メールマガジンその他の方法による情報提供（広告を含みます）を行うことができるものとします。会員が情報提供を希望しない場合は、当社所定の方法に従い、その旨を通知して頂ければ、情報提供を停止します。ただし、本サービス運営に必要な情報提供につきましては、会員の希望により停止をすることはできません。<br><br>
				第7条（禁止事項）<br><br>
	...
	<a href="/signup/subscribe" class="submit_sys block">会員規約に同意し、会員登録をする</a>
