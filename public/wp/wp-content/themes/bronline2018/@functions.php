 ...
 * @return array			取得結果
 */
function get_feature_related_list( $serise, $tag, $per_page = 12, $page = 1) {
	$arrIds = array();
 ...
 * @return array		取得結果
 */
function get_style_snap_related_list() {
	$params = array();
	$params['type'] = "stylesnap";
	$params['page'] = 1;
	$params['per_page'] = 5;
 ...
 * @return array		取得結果
 */
function get_editors_choice_related_list() {
	$params = array();
	$params['type'] = "editorschoice";
	$params['page'] = 1;
	$params['per_page'] = 5;
 ...
 * @return number|boolean		結果　成功：登録ID / 失敗：false
 */
function add_br_braand( $brand_name, $brand_code ) {
	global $wpdb;
